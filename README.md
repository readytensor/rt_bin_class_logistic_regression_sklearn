# Logistic Regression Classifier in Scikit-Learn with Shapley Explanations
## Project Description
...
- A **Logistic Regression** algorithm built using **SciKit-Learn**
...
- **`src/`**: This directory holds the source code for the project. It is further divided into various subdirectories:
  ...
  - **`prediction/`**: Scripts for the Logistic Regression classifier model implemented using **Scikit-Learn** library.
